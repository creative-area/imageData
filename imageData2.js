...
;(function(window, $, document, undefined) {
	...
	*/
	...
	var methods = {
		...
		draw: function( dataURL, options, callback ) {
			var defaults = {
				type: false,
				orientation: _imageData.orientation || 1
			}
			...
			return $.Deferred(function( defer ) {
				...
				image.onload = function() {
					...
					transformOrientation(canvas, imageWidth, imageHeight, settings.orientation);
